...
const TimeLineData = [
	{ year: 2025, text: "Start my journey as a Fronted Software Developer" },
	{ year: 2024, text: "Start my journey as a Quality Analyst Intern" },
];
	...
	return (
		<LazyMotion features={domAnimation}>
			<ul
				...
				className="flex flex-row flex-nowrap gap-5 justify-normal overflow-x-auto snap-x cursor-pointer hide-scroll-bar"
			>
				<>
